...
@section('content')
                ...
                <div class="row justify-content-center">
                  ...
                  @endif --}}
                            <div class="card-header">
                                ...
                                <button type="button" id="btn-add-kecamatan" class="btn btn-sm btn-primary float-right"
                                    data-toggle="modal" data-target="#modal-add-kecamatan">
                  ...
                  @endif --}}
                            <div class="card-header">
                                ...
                                <button type="button" id="btn-add-kelurahan" class="btn btn-sm btn-primary float-right"
                                    data-toggle="modal" data-target="#modal-add-kelurahan">
                                    <i class="fas fa-plus-circle"></i>
                                    Tambah Kelurahan
                                </button>
                            </div>
    ...
    <form id="form-add-kecamatan">
        <div class="modal fade" id="modal-add-kecamatan" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
    ...
    <form id="form-edit-kecamatan">
        <div class="modal fade" id="modal-edit-kecamatan" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="">Nama Kecamatan</label>
                                    <input type="text" class="form-control" id="nm_kecamatan_e" name="nm_kecamatan"
                                        required>
                                </div>
                            </div>
                        </div>
    ...
    <form id="form-add-kelurahan">
        <div class="modal fade" id="modal-add-kelurahan" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
    ...
    <form id="form-edit-kelurahan">
        <div class="modal fade" id="modal-edit-kelurahan" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="">Nama Kelurahan</label>
                                    <input type="text" class="form-control" id="nm_kelurahan_e" name="nm_kelurahan"
                                        required>
                                </div>
                            </div>
                        </div>
